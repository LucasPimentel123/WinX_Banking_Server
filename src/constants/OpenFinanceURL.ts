export default class OpenFinanceURL {
    public static readonly  OPEN_FINANCE_URL_BASE = "http://172.20.10.2:3000";    
    ...
    public static readonly OPEN_FINANCE_CREDIT_TRANSACTIONS_URL = `${OpenFinanceURL.OPEN_FINANCE_URL_BASE}/credit/{{account_id}}/transactions`
